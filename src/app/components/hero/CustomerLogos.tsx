  ...
  return (
    <div className="py-8">
      <div className="text-center mb-6">
        <p className="text-launcherpad-dark-blue/60 text-sm font-medium">
      ...
      <div className="grid grid-cols-3 md:grid-cols-6 gap-4 md:gap-8 items-center justify-items-center">
        {companies.map((company) => (
          <div
            key={company.id}
            className="flex items-center justify-center transition-all duration-300 hover:opacity-100 group"
          >
