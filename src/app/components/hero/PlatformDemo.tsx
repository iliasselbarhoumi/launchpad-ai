              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div className="bg-launchpad-purple/5 p-4">
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div className="bg-launchpad-purple h-2 rounded-full" style={{width: '75%'}}></div>
                  </div>
            ...
            <div className="col-span-4 space-y-4">
              ...
              <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-launchpad-purple font-medium">Warm</span>
                </div>
              </div>
              ...
              <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                ...
                <div className="text-launchpad-purple font-medium text-sm">3 Interactions</div>
              </div>
              ...
              <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                ...
                <div className="w-full bg-gray-200 rounded-full h-2 mb-1">
                  <div className="bg-launchpad-purple h-2 rounded-full" style={{width: '85%'}}></div>
                </div>
                <div className="text-right text-sm font-medium text-launchpad-purple">85%</div>
              </div>
              ...
              <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                ...
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-launchpad-purple rounded-full"></div>
                  <span className="text-launchpad-purple font-medium">Warm - 3 Previous Interactions</span>
                </div>
              </div>
              ...
              <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="bg-launchpad-purple/10 text-launchpad-purple text-xs px-2 py-1 rounded-md">AI Analytics</span>
              ...
              <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-launchpad-purple font-medium">Active Now</span>
                </div>
              </div>
