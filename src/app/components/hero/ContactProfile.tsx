    ...
    <div className="bg-white/5 rounded-xl p-4 backdrop-blur-sm border border-white/5">
      ...
      <div className="flex items-center mb-4">
        ...
        <div>
          ...
          <p className="text-white/60 text-xs">
            VP of Operations, TechScale Inc.
          </p>
        </div>
      </div>
      ...
      <div className="space-y-2.5 mb-4">
        ...
        <div className="h-1.5 bg-white/10 rounded-full overflow-hidden">
          <div
            className="h-full bg-gradient-to-r from-[#6936F5] to-[#6936F5] rounded-full"
            style={{ width: "87%" }}
          ></div>
        </div>
        ...
        <div className="h-1.5 bg-white/10 rounded-full overflow-hidden">
          <div
            className="h-full bg-[#6936F5] rounded-full"
            style={{ width: "73%" }}
          ></div>
        </div>
      </div>

      <div className="bg-launcherpad-dark-blue/50 rounded-lg p-3">
        <h4 className="text-white/90 text-xs font-medium mb-2">
          Social Channels
        </h4>
