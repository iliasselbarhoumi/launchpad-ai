      ...
      <div className="container-section">
        ...
        >
          ...
          <div className="bg-white rounded-2xl border border-launchpad-light-gray/60 p-8 shadow-sm transition-all duration-300 hover:shadow-xl hover:shadow-launchpad-cyan/5 hover:border-launchpad-cyan/20 hover:-translate-y-1">
            <div className="text-xl font-bold text-launchpad-dark-blue mb-2">Starter</div>
            <div className="text-launchpad-dark-blue/60 mb-6">For individual sales professionals</div>
            
            <div className="flex items-end mb-6">
              <div className="text-4xl font-bold text-launchpad-dark-blue">$49</div>
              <div className="text-launchpad-dark-blue/60 ml-1 mb-1">/month</div>
            </div>
          ...
          <div className="bg-white rounded-2xl border border-launchpad-cyan/30 p-8 shadow-xl shadow-launchpad-cyan/5 relative">
            ...
            <div className="text-xl font-bold text-launchpad-dark-blue mb-2">Professional</div>
            <div className="text-launchpad-dark-blue/60 mb-6">For growing sales teams</div>
            
            <div className="flex items-end mb-6">
              <div className="text-4xl font-bold text-launchpad-dark-blue">$149</div>
              <div className="text-launchpad-dark-blue/60 ml-1 mb-1">/month</div>
            </div>
          ...
          {/* Enterprise Plan */}
          <div className="bg-white rounded-2xl border border-launchpad-light-gray/60 p-8 shadow-sm transition-all duration-300 hover:shadow-xl hover:shadow-launchpad-cyan/5 hover:border-launchpad-cyan/20 hover:-translate-y-1">
            <div className="text-xl font-bold text-launchpad-dark-blue mb-2">Enterprise</div>
            <div className="text-launchpad-dark-blue/60 mb-6">For larger organizations</div>
            
            <div className="flex items-end mb-6">
              <div className="text-4xl font-bold text-launchpad-dark-blue">Custom</div>
            </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-launchpad-dark-blue to-launchpad-dark-blue/90 rounded-2xl p-8 md:p-12">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="mb-6 md:mb-0">
              ...
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-2">See How Launchpad AI Works</h3>
              <p className="text-white/70 max-w-xl">
                Get a personalized demo and see how Launchpad can transform your outbound strategy.
              </p>
            </div>
            <div>
