      ...
      <div className="container-section max-w-6xl mx-auto">
        ...
        >
          <motion.h2 
            ...
            className="text-4xl md:text-5xl font-semibold text-launchpad-dark-blue mb-6 tracking-tight"
          >
        ...
        >
          ...
          >
            <div className="px-8 py-6 border-b border-gray-200 flex items-center justify-between">
              ...
              <div className="text-sm text-gray-500">launchpad.ai/dashboard</div>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-8">
              <div className="flex flex-col justify-center">
                <h3 className="text-2xl font-semibold text-launchpad-dark-blue mb-4">
              ...
              <div className="bg-white rounded-[20px] border border-gray-200 p-6">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-launchpad-dark-blue">Insights Report</h3>
                </div>
