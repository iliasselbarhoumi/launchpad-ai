      ...
      <div className="container-section relative z-10">
        ...
        >
          ...
          <motion.h2
            ...
            className="heading-lg text-launcherpad-dark-blue mb-6"
          >
          ...
          <motion.p
            variants={itemVariants}
            className="text-launcherpad-dark-blue/80 text-lg mb-8 max-w-2xl mx-auto"
          >
        ...
        >
          ...
          >
            ...
            <h3 className="heading-sm text-launcherpad-dark-blue mb-8 flex items-center">
            ...
            <ul className="space-y-6">
              <li className="flex items-start">
                ...
                <div>
                  <p className="font-semibold text-lg text-launcherpad-dark-blue">
                    1% cold email response rates
                  </p>
                  <p className="text-launcherpad-dark-blue/70 mt-1">
          ...
          <motion.div
            ...
            className="bg-[#F9F6F3] rounded-[20px] p-8 border border-gray-100 relative overflow-hidden group"
          >
            <div className="absolute top-0 right-0 bg-launcherpad-purple/10 px-4 py-2 rounded-bl-2xl">
              <Check className="w-5 h-5 text-launcherpad-purple" />
            </div>

            <h3 className="heading-sm text-launcherpad-dark-blue mb-8 flex items-center">
              AI Organic Outbound
              <span className="ml-2 px-2 py-0.5 text-xs font-medium bg-launcherpad-purple/10 text-launcherpad-purple rounded-full">
                Launcherpad
              </span>
            </h3>
            ...
            <ul className="space-y-6">
              <li className="flex items-start">
                <div className="flex-shrink-0 w-8 h-8 rounded-full bg-launcherpad-purple/10 flex items-center justify-center mt-0.5 mr-4">
                  <Check className="w-4 h-4 text-launcherpad-purple" />
                </div>
                <div>
                  <p className="font-semibold text-lg text-launcherpad-dark-blue">
            ...
            <div className="mt-12 grid grid-cols-3 gap-4">
              <div className="aspect-square flex flex-col items-center justify-center bg-launcherpad-purple/5 rounded-xl p-3">
                <Users className="w-8 h-8 text-launcherpad-purple mb-2" />
                <div className="text-sm text-center text-launcherpad-purple font-medium">
                  Engagement
                </div>
              </div>

              <div className="aspect-square flex flex-col items-center justify-center bg-launcherpad-purple/5 rounded-xl p-3">
                <Zap className="w-8 h-8 text-launcherpad-purple mb-2" />
                <div className="text-sm text-center text-launcherpad-purple font-medium">
                  Trust Building
                </div>
              </div>
              ...
              <div className="aspect-square flex flex-col items-center justify-center bg-launcherpad-purple/5 rounded-xl p-3">
                <BarChart3 className="w-8 h-8 text-launcherpad-purple mb-2" />
                <div className="text-sm text-center text-launcherpad-purple font-medium">
                  Win More Deals
                </div>
              </div>
            ...
            <div className="absolute -bottom-1 left-0 right-0 h-1 bg-launcherpad-purple"></div>
          </motion.div>
        </motion.div>
      </div>
    </section>
