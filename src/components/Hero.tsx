    ...
    <section className="relative min-h-screen pt-12 pb-32 overflow-hidden ">
      ...
      <div className="container-section relative z-10">
        ...
        >
          ...
          >
            <span className="text-sm font-medium font-inter tracking-wide">🚀 Democratizing Entrepreneurship</span>
          </motion.div>
          ...
          >
            From <span className="text-[#EA384C] font-extrabold">Idea</span> to <span className="text-[#6936F5] font-extrabold">Impact</span>
          </motion.h1>
          ...
          >
            AI brings your vision to life, with personalized insights every step of the way
          </motion.p>
