...
const HowItWorks = () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "Launchpad creates meaningful touchpoints that position you as a trusted advisor by engaging with prospects' content and contributing value.",
      ...
      <div className="container-section py-4">
        <div className="max-w-3xl mx-auto text-center mb-6">
          ...
          <h2 className="heading-lg text-launchpad-dark-blue mb-4">
            How <span className="gradient-text">Launchpad.ai</span> Works in 3 Steps
          </h2>
