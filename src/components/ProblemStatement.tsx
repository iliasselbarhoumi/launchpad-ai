      ...
      <div className="container-section relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="text-launchpad-purple font-extrabold">AI Organic Outbound</span> Does.
          </motion.h2>
          ...
          >
            The days of cold calls and emails are over. Today's buyers expect personalized engagement from people they trust. Launchpad.ai puts you exactly where your buyers make decisions.
          </motion.p>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <ul className="space-y-6">
              <li className="flex items-start">
                ...
                <div>
                  <p className="font-semibold text-lg text-launchpad-dark-blue">1% cold email response rates</p>
                  <p className="text-launchpad-dark-blue/70 mt-1">Millions of emails sent, almost all ignored</p>
                </div>
              </li>
              ...
              <li className="flex items-start">
                ...
                <div>
                  <p className="font-semibold text-lg text-launchpad-dark-blue">80% of calls screened out</p>
                  <p className="text-launchpad-dark-blue/70 mt-1">Decision makers don't take cold calls</p>
                </div>
              </li>
              ...
              <li className="flex items-start">
                ...
                <div>
                  <p className="font-semibold text-lg text-launchpad-dark-blue">No relationship before outreach</p>
                  <p className="text-launchpad-dark-blue/70 mt-1">Cold outreach feels impersonal and salesy</p>
                </div>
              </li>
            </ul>
          ...
          >
            ...
            <h3 className="heading-sm text-launchpad-dark-blue mb-8 flex items-center">
              AI Organic Outbound
              <span className="ml-2 px-2 py-0.5 text-xs font-medium bg-launchpad-purple/10 text-launchpad-purple rounded-full">Launchpad.ai</span>
            </h3>
            ...
            <ul className="space-y-6">
              <li className="flex items-start">
                ...
                <div>
                  <p className="font-semibold text-lg text-launchpad-dark-blue">15x higher conversion rates</p>
                  <p className="text-launchpad-dark-blue/70 mt-1">Build trust before you reach out</p>
                </div>
              </li>
              ...
              <li className="flex items-start">
                ...
                <div>
                  <p className="font-semibold text-lg text-launchpad-dark-blue">Key touchpoints and discussions</p>
                  <p className="text-launchpad-dark-blue/70 mt-1">Tracks the entire buyer's journey</p>
                </div>
              </li>
              ...
              <li className="flex items-start">
                ...
                <div>
                  <p className="font-semibold text-lg text-launchpad-dark-blue">Fully automated growth hacking</p>
                  <p className="text-launchpad-dark-blue/70 mt-1">Enterprise-grade AI engagement</p>
                </div>
              </li>
            </ul>
            ...
            <div className="mt-12 grid grid-cols-3 gap-4">
              <div className="aspect-square flex flex-col items-center justify-center bg-launchpad-purple/5 rounded-xl p-3">
                ...
                <div className="text-sm text-center text-launchpad-purple font-medium">Engagement</div>
              </div>
              
              <div className="aspect-square flex flex-col items-center justify-center bg-launchpad-purple/5 rounded-xl p-3">
                <Zap className="w-8 h-8 text-launchpad-purple mb-2" />
                <div className="text-sm text-center text-launchpad-purple font-medium">Trust Building</div>
              </div>
              
              <div className="aspect-square flex flex-col items-center justify-center bg-launchpad-purple/5 rounded-xl p-3">
                <BarChart3 className="w-8 h-8 text-launchpad-purple mb-2" />
                <div className="text-sm text-center text-launchpad-purple font-medium">Win More Deals</div>
              </div>
            </div>
