...
import GeneratingMvpPrompt from "@/components/ideas/GeneratingMvpPrompt";
import MvpPromptResult from "@/components/ideas/MvpPromptResult";
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <main className="max-w-7xl mx-auto p-4 sm:p-6 pt-28">
        <div className="mb-6">
          <Button variant="ghost" onClick={() => navigate("/ideas/list")}>
